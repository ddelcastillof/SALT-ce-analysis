...
```{r describing data}
# desenlaces
## muerte: 35 deaths across all rounds
table(raw_long_dta$pvivo)

## eventos cv: 79 CV events across all rounds
table(raw_long_dta$derrame)
table(raw_long_dta$infarto)
table(raw_long_dta$insuficiencia)
table(raw_long_dta$otracor)
